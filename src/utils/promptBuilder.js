...
- 店主のヒントがある場合、その言葉をそのまま核にして文章を組み立てる。AIが上手く書き換えない
...
${isButtonHint
  ...
  : hint && options.hintType === 'viewpoint'
    ? `\n【投稿の切り口（最重要）】\n「${hint}」をこの投稿の核として扱ってください。\n本文の内容・視点・語り口はすべてこの切り口から組み立ててください。\nこの切り口をぼかさず、写真の中にある具体的な空気感・温度・雰囲気として自然に表現してください。\n- 3案はそれぞれ異なるアプローチでこの切り口を展開すること`
    : hint
