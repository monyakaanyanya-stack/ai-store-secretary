...
- 綺麗にまとまりすぎた文章は「誰が書いても同じ」に見える。それが一番もったいない
- 「この店・この瞬間でしか成立しない具体的な不純物」を必ず入れる
  - もったいない例: 「あま〜いバニラの香りが漂ってきそう」（どのカフェでも言える）
  - いい例: 「オーブン開けた瞬間のチーズの焦げた匂い、たまらん」（この店の今日の体験）
- 店主の一言ヒントがある場合、その言葉をそのまま核にして文章を組み立てる。AIが上手く書き換えない。生の言葉をそのまま活かす
...
- 綺麗にまとまりすぎた文章は「誰が書いても同じ」に見える。それが一番もったいない
- 「この店・この瞬間でしか成立しない具体的な不純物」を必ず入れる
- 店主が伝えたい内容がある場合、その言葉をそのまま核にして文章を組み立てる。AIが上手く書き換えない。生の言葉をそのまま活かす
- 失敗談・ツッコミ・不完全な表現は「味」になる。排除せず積極的に残す
- 「上手い文章」より「本人が書いたっぽい文章」を最優先する
