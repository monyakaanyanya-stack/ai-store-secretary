...
表面的な意図（「大きく伝えたかった」）で止まらず、その先にある感情・文脈まで踏み込む。
例：「見上げることで被写体を主役にしつつ、空の広がりと季節の寂寥感を強調したかったから。」
技術用語を使わず、撮影者の感情・意図として読み解く。
...
▼ 層3：📸 写真家のコメント（1行）
「📸 」で始める（固定）。
撮影技術を「店主の優しさ・意図」として翻訳して1行で書く。
例：「ピントをあえて外したのは、その場の空気全体を包み込みたかったから。」
カメラ用語（F値・ISO・ボケ量）は使わない。
禁止ワード：素晴らしい・完璧・最高・美しい・魅力的
