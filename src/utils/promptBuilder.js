...
${isButtonHint
  ...
  : hint && options.hintType === 'viewpoint'
    ? `\n【この写真のDetection（発見）】\n「${hint}」\n\n【投稿の組み立て方】\nこのDetectionを「店主が作業中にふと気づいたこと」として独り言に入れる。\n① 今やっていた作業（1行）\n② Detectionに気づいた瞬間の独り言（1-2行）\n③ 軽い一言（1行）\n\nルール:\n- Detectionを「説明」するのではなく、店主の行動の中で自然に触れる\n- 例: Detection「ソースの赤い点がいい」→「赤いソース3滴、これ結構好き」\n- 例: Detection「黒いテーブルが器を引き立ててる」→「この黒いテーブルに置くとなんか映えるんだよな」\n- 3案はそれぞれDetectionの異なる面を広げること（同じ言い換えNG）`
    : hint
