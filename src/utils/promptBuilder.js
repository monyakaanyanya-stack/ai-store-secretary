...
- **80点＋20点**: 完結させない。店主が最後に言葉を乗せるための「余白」を必ず残す。
- **絵文字**: キャプション全体で最大2個まで。
${equipmentSection}
...
[ 案A：質感 ]
（手触り・表面・重さ・硬さなど、触覚を主軸に。名詞止め。不揃いな呼吸。宣伝文句は入れない。）
${hashtagInstruction ? '\n上記のハッシュタグルールに従うこと。' : ''}
#タグ1 #タグ2 #タグ3 #タグ4 #タグ5

[ 案B：空気 ]
（光・温度・距離感・湿度など、空間の気配を主軸に。案Aとは別の五感で書く。）

#タグ1 #タグ2 #タグ3 #タグ4 #タグ5

[ 案C：記憶 ]
（この写真が呼び起こす身体的な記憶・体験を主軸に。案A・Bとは異なる角度で。）
