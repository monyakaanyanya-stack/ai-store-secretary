...
## 2. 禁止ワード
${toneData.forbidden_words.join(', ')}, 幻想的, 素敵, 魅力的, 素晴らしい, 完璧, 最高, 美しい, まじ, まじで, やばい, やばすぎ, 超, めっちゃ, 美味しい, 絶品, こだわり, 自慢の, 人気の, 話題の, 光の意志, 質感の物語, 沈黙のデザイン, 肖像, 独白, 映えて, 映える, 光景, 恋しくなる, 恋しい
...
③ 軽い締め — 自分だけの気付きや体験で終わる（毎回違う言い回しにすること）`;
  ...
  // 禁止ワード（1行にまとめる）
  const allForbidden = [...new Set([...toneData.forbidden_words, '幻想的', '素敵', '魅力的', '素晴らしい', '完璧', '最高', '美しい', 'まじ', 'まじで', 'やばい', 'やばすぎ', '超', 'めっちゃ', '美味しい', '絶品', 'こだわり', '自慢の', '人気の', '話題の', '光の意志', '質感の物語', '沈黙のデザイン', '肖像', '独白', '映えて', '映える', '光景', '恋しくなる', '恋しい'])];
