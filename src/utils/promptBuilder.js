...
【各案の構成】
1. 本文（自分の口調で自然に。${lengthInfo.range}）
2. 想起の一言（五感を1つ含める・15〜25文字・改行して書く）
3. もっと見たくなる一文（フォローや他投稿への自然な導線・改行して書く）
4. ハッシュタグ

【重要ルール】
- ⚠️ 本文は「${lengthInfo.range}」を**最優先の絶対制限**とする。
- 本人が実際に言いそうな語り口にする
- 想起の一言は五感（香り・音・温度・光・手触り）のどれか1つを必ず含める
...
🎯 明日撮るべきコンテンツ
上記の撮影提案に加えて、「明日これを撮ってください」と具体的に1つだけ指定する。
被写体・アングル・タイミングを明確に書く（例: 「朝のルーティンで手元だけを真上から。自然光が入る窓際で」）。
その撮影が「なぜ反応が取れそうか」を、この分野の傾向やデータを踏まえて1文で説明する。
例: 「朝のルーティン系は"リアルな生活感"として保存されやすい傾向があります」` : ''}
━━━━━━━━━━━━━━━━━━━━━━━━
