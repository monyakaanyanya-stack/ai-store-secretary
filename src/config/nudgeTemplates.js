...
export const NUDGE_TEMPLATES = {
  ...
  beauty: [
    ...
    { subject: 'ネイルのパーツ選び', cameraTip: 'パーツを指先に乗せて自然光の下で', description: '選ぶ過程に店主のセンスが出る', season: null },
  ...
  retail: [
    ...
    { subject: '店内のいちばん好きな角度', cameraTip: 'お客さんが入ってくる方向から', description: '店主が好きな景色はお客さんも好きになる', season: null },
