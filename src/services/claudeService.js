...
6. 写真の観察（3つの視点）— この写真を3つの異なる視点で観察し、それぞれ投稿の核になる一文を書く。
   3つの視点はそれぞれ異なるカテゴリから選ぶこと（例: 空間/光/過ごし方、素材/温度/行動 など）。
...
- 1〜5は箇条書き
- 6の観察は「この写真のどこに注目すれば投稿になるか」を提案する。写真の説明や感想ではない
- 6の3つはそれぞれ異なるカテゴリの視点で（同じカテゴリを2回使わない）`,
            },
          ],
        },
      ],
